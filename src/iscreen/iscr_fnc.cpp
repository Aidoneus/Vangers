...
#ifndef _ACI_SKIP_MAINMENU_
        iSetOptionValueCHR(iPLAYER_NAME2, (lang() == RUSSIAN ? "Ç†≠É•‡" : "Vanger"));
        iSetOptionValueCHR(iPLAYER_PASSWORD, iSTR_DefaultPassword);
        iSetOptionValueCHR(iHOST_NAME, "vangers.net");
        iSetOptionValueCHR(iSERVER_NAME, (lang() == RUSSIAN ? "åÆÔ Ø•‡¢†Ô ®£‡†!" : "My first game!"));
...
*/
	...
	//TODO: stalkerg –°—Ç–≤–æ—Ä–∫–∏ —Å–ª–æ–º–∞–Ω—ã —Ç—É—Ç!
	for(i = 0; i < max_timer; i ++)
