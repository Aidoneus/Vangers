...
void iGetMultiGameParameters(void)
{
	...
	switch(iCurMultiGame){
		...
		case iMP_PASSEMBLOSS:
			...
			if (strcmp(game_name,"triacxlon")==0 || strcmp(game_name,"‚‡®†ÊÂ´Æ≠")==0) value = 999999;
			...
			if (strcmp(game_name,"triacxlon")==0 || strcmp(game_name,"‚‡®†ÊÂ´Æ≠")==0) value = 0;
			...
			if (strcmp(game_name,"satinan")==0 || strcmp(game_name,"·†‚®≠†≠")==0) value = (iGetMultiGameParameter(iMP_PASSEMBLOSS, iMP_CHECKPOINTS_NUM) * 2) + 1;
			...
			if (strcmp(game_name,"vozvrat")==0 || strcmp(game_name,"¢Æß¢‡†‚")==0) value = 1;
			...
			if (strcmp(game_name,"triacxlon")==0 || strcmp(game_name,"‚‡®†ÊÂ´Æ≠")==0) value = 36;
			...
			if (strcmp(game_name,"triacxlon")==0 || strcmp(game_name,"‚‡®†ÊÂ´Æ≠")==0) value = 2;
